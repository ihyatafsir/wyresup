...
async function runLisanSwarmAudit() {
  ...
  const reportPath = path.join(__dirname, '../../../../brain/565c1210-a8e9-44ff-9ba8-0427cbea30e7/lisan_deepseek_swarm_audit_report.md');
...
with open('/home/absolut7/Documents/news/wyresup-mesh-app/scripts/run_lisan_al_arab_deepseek_swarm.js', 'w') as f:
    f.write(code)

print("Generated scripts/run_lisan_al_arab_deepseek_swarm.js successfully!")
